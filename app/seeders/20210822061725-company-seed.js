module.exports = {
  up: async (queryInterface, Sequelize) => {
    return await queryInterface.bulkInsert('companies', [
      ...
      {id: 17, name: 'Vim', stock_price: 4.56, description: 'Huge contractor in the Real Estate market. Infamous for their zoning strategy to increase the price.', sectorId: 5, createdAt: new Date(), updatedAt: new Date()},
      {id: 18, name: 'Fake Land Contractor Group', stock_price: 0.49, description: 'Build bunch of condos at a price that no ordinary worker can afford.', sectorId: 5, createdAt: new Date(), updatedAt: new Date()},
      ...
      {id: 20, name: 'Petrolamex Corp', stock_price: 0.48, description: 'A company that mine the precious crude oil in our soil and sell for peanuts.', sectorId: 6, createdAt: new Date(), updatedAt: new Date()},
